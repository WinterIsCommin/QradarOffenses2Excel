...
def write2excel():
    okay_des_list, okay_status_list, okay_id_list = id_validate()
    df1 = pd.DataFrame({'Offense ID': okay_id_list})
    df2 = pd.DataFrame({'Status': okay_status_list})
    df3 = pd.DataFrame({'Description': okay_des_list})
